...
public class Growth_Girl extends Activity{
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.growth_girl);
	        ...
	        btn.setOnClickListener(new OnClickListener()
	        {
				...
				txtHeading.setText("Standard Height and weight of Baby Girl of " + selected + " Month is :");
				//Toast.makeText(getApplicationContext(), selected, Toast.LENGTH_LONG).show();
				if(selected.equals("0") || selected.equals("1") || selected.equals("2"))
				{
					txtheigh.setText("49.9");
					txtWeight.setText("3.2");
				}
				else if(selected.equals("3") || selected.equals("4") || selected.equals("5"))
				{
					txtheigh.setText("60.2");
					txtWeight.setText("5.4");
				}
				else if(selected.equals("6")|| selected.equals("7") || selected.equals("8"))
				{
					txtheigh.setText("66.6");
					txtWeight.setText("7.2");
				}
				else if(selected.equals("9")|| selected.equals("7"))
				{
					txtheigh.setText("71.1");
					txtWeight.setText("8.6");
				}
				...
				{
					txtheigh.setText("75.0");
					txtWeight.setText("9.5");
				}
				...
				{
					txtheigh.setText("84.5");
					txtWeight.setText("11.8");
				}
				...
				{
					txtheigh.setText("93.9");
					txtWeight.setText("14.1");
				}
				...
				{
					txtheigh.setText("101.6");
					txtWeight.setText("16.0");
				}
				...
				{
					txtheigh.setText("108.4");
					txtWeight.setText("17.7");
				}
				...
				{
					txtheigh.setText("114.6");
					txtWeight.setText("19.5");
				}
				...
				{
					txtheigh.setText("120.6");
					txtWeight.setText("21.8");
				}
				...
				{
					txtheigh.setText("126.4");
					txtWeight.setText("24.8");
				}
				...
				else if(selected.equals("108")|| selected.equals("109") || selected.equals("110") || selected.equals("111") || selected.equals("112") || selected.equals("113") || selected.equals("114") || selected.equals("115") || selected.equals("116") || selected.equals("117") || selected.equals("118") || selected.equals("119"))
				{
					...
					txtWeight.setText("28.5");
				}	
				else if(selected.equals("120"))
				{
					txtheigh.setText("138.3");
					txtWeight.setText("32.5");
				}
				else
				{
